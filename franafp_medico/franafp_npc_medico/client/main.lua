    ...
    while true do
        ...
        for medicIndex, medic in ipairs(Medics) do
            ...
            if dstCheck <= 3.0 then
                ...
                local displayText = usable and "Presiona [~y~E~s~] para recibir un ~b~tratamiento médico~s~ por (~g~$" .. medic.Price .. "~s~)" or "~b~El médico~s~ no esta disponible ~r~actualmente~s~, por favor, espere..."
