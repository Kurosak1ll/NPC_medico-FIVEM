Medics = {
    {
        ...
        Price = 0, -- Esre es el precio que deben pagar para ser tratados
    

        Sequence = { --Este es el espacio que el medico recorre
    ...
    --{ -- Para añadir mas NPCs
    --    Location = vector3(312.22305297852, -592.88073730469, 43.284034729004),
    --    Heading = 340.0,  -- Hacia donde mira el NPC
    --
    --    Hash = 0xB353629E,
    --
    --    Price = 1 -- El precio
